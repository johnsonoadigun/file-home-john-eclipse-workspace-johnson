...
public class SecurityConfig extends WebSecurityConfigurerAdapter{ 
	...
	protected void configure(HttpSecurity http) throws Exception {
		JwtSecurityAuthenticationjwt jwtAuthentication = new JwtSecurityAuthenticationjwt(authenticationManager());
		...
		.and().addFilter(jwtAuthentication)
		.addFilterBefore(new JwtSecurityAuthorization(), UsernamePasswordAuthenticationFilter.class);
	}
